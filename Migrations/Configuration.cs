namespace WhoLetDerHundOut.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<WhoLetDerHundOut.DAL.DogContext>
    {
        ...
        protected override void Seed(WhoLetDerHundOut.DAL.DogContext context)
        {
            ...
            dogs.ForEach(d => context.Dogs.AddOrUpdate(p => p.nickName, d));
            context.SaveChanges();
            ...
            var user = new List<Users>
           {
            ...
            user.ForEach(d => context.User.AddOrUpdate(p => p.Name, d));
            context.SaveChanges();
            ...
            breeds.ForEach(d => context.Breeds.AddOrUpdate(p => p.BreedName, d));
            context.SaveChanges();
        }
    }
}
